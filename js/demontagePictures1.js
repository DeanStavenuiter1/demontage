...
demontageOnePics.forEach((picture) => {
    ...
    let imgTag = `<img class="img" src="${picture}" alt="demontage-pics" loading="lazy">`

   photoAlbum.innerHTML += imgTag;

        singleImg = document.querySelector(".img")
        imgWidth = singleImg.clientWidth
        imgHeight = singleImg.clientHeight
